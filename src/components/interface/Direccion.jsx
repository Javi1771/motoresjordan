...
const Direccion = () => {
  ...
  const sucursal1Map = "https://www.google.com.mx/maps/place/Moto-Bombas+y+Reductores+Jordan+S.A+de+C.V./@20.3917469,-99.9957687,935m/data=!3m3!1e3!4b1!5s0x85d30b628732a6ab:0xac2f3bcd1e252bed!4m6!3m5!1s0x85d30b6280a9afff:0x80a19ba652dc9adb!8m2!3d20.391747!4d-99.9908978!16s%2Fg%2F11bx89x828?hl=es&entry=ttu&g_ep=EgoyMDI1MDcyMC4wIKXMDSoASAFQAw%3D%3D";
  
  const sucursal2Map = "https://www.google.com.mx/maps/@20.366105,-99.9574319,3a,75y,144.67h,92.4t/data=!3m7!1e1!3m5!1s0WbjlgXpECyG4Ch1diDCIw!2e0!6shttps:%2F%2Fstreetviewpixels-pa.googleapis.com%2Fv1%2Fthumbnail%3Fcb_client%3Dmaps_sv.tactile%26w%3D900%26h%3D600%26pitch%3D-2.4039200749683403%26panoid%3D0WbjlgXpECyG4Ch1diDCIw%26yaw%3D144.66835371465618!7i16384!8i8192?hl=es&entry=ttu&g_ep=EgoyMDI1MDcyMC4wIKXMDSoASAFQAw%3D%3D";
    ...
    <div className="bg-gradient-to-br from-[#262626]/90 to-[#1a1a1a]/90 backdrop-blur-sm rounded-xl lg:rounded-2xl p-6 lg:p-8 border border-[#4E4F50]/50 hover:border-[#BE171F]/50 transition-all duration-300 hover:shadow-xl hover:shadow-[#BE171F]/10">
      ...
      <div className="space-y-8">
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="p-4 md:w-3/5">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:4272724036" className="text-[#8E8F91] hover:text-[#F43F48] transition-colors">
                  427 272 4036
                </a>
              </div>
            </div>
        ...
        <div className="bg-[#1a1a1a]/50 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-[#BE171F]/20">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="p-4 md:w-3/5">
              ...
              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-[#BE171F] flex-shrink-0" />
                <a href="tel:4271011168" className="text-[#8E8F91] hover:text-[#F43F48] transition-colors">
                  427 101 1168
                </a>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-[#BE171F]/20 to-[#F43F48]/10 rounded-xl p-4 border border-[#BE171F]/30 flex items-center">
          ...
          <div>
            <h4 className="font-bold text-white text-lg">Email Corporativo</h4>
            <a 
              href="mailto:contacto@motoresjordanmx.com" 
              className="text-[#D0D0D1] mt-1 hover:text-[#F43F48] transition-colors block"
            >
